import { Icon } from "@workspace/rn-ui/components/icon";
import { NativeOnlyAnimatedView } from "@workspace/rn-ui/components/native-only-animated-view";
import { TextClassContext } from "@workspace/rn-ui/components/text";
        ...
        >
            ...
            >
                ...
                <Icon
                    as={icon}
                    className={cn(
                        "text-foreground size-4 shrink-0",
                        iconClassName
                    )}
                />
            </DropdownMenuPrimitive.SubTrigger>
